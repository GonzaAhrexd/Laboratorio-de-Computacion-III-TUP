...
class Program
{
    static void Main()
    {
        ...
        Persona JavierMilei = new Persona(22345678, "Javier", "Milei", 53, "3625123456", "persona en actividad laboral");
        Cuenta cuentaM = new Cuenta(JavierMilei);
        banco.cuentas.Add(cuentaM);
        ...
        while (true){
            ...
            switch (opcion){
                case 1:
                    ...
                    if (tipoCuenta.ToLower() == "persona en actividad"){
